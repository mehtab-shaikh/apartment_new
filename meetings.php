...
<div class='mainContainer'>
							...
							echo "</tr>";
							$res= mysqli_query($conn,"select * from meetings");
							while($row=mysqli_fetch_array($res))
							{								
								echo '<tr><td>'.$row["imageFileName"].'</td>';
								echo '<td>'.$row["description"].'</td>';
								echo '<td><a href=./UploadedFile/'.$row["imageFileName"].' target="blank">Open</td>';
								echo "<td>";?> <a href="deleteMeetingsAttachment.php?doc_id=<?php echo $row["doc_id"]; ?>">Delete This</a> <?php echo "</td></tr>";
							}
							...
							if(isset($_POST['submit']))
							{
								...
								$qry="INSERT INTO `meetings`( `description`, `imageFileName`) VALUES ('$description','$fileName')";
