...
<title>admin dash</title>
	...
	<script type='text/javascript' src='js/rulesAndRegulations.js'></script>
</head>
<style>
table, th, td {
...
<div class='mainContainer'>
							...
							echo "</tr>";
							$res= mysqli_query($conn,"select * from lawsandrules");
							...
							if(isset($_POST['submit']))
							{
								...
								$qry="INSERT INTO `lawsandrules`( `description`, `imageFileName`) VALUES ('$description','$fileName')";
