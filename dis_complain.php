...
<title>admin dash</title>
	...
	<script type='text/javascript' src='js/dis_complain.js'></script>
</head>
<style>
table, th, td {
...
<div class='mainContainer'>
							...
							echo "</tr>";
							$res= mysqli_query($conn,"select * from dis_complain");
							while($row=mysqli_fetch_array($res))
							{								
								echo '<tr><td>'.$row["imageFileName"].'</td>';
								echo '<td>'.$row["description"].'</td>';
								echo '<td><a href=./UploadedFile/'.$row["imageFileName"].' target="blank">Open</td>';
								echo "<td>";?> <a href="deleteDis_ComplainAttachment.php?doc_id=<?php echo $row["doc_id"]; ?>">Delete This</a> <?php echo "</td></tr>";
							}
							...
							if(isset($_POST['submit']))
							{
								...
								$qry="INSERT INTO `dis_complain`( `description`, `imageFileName`) VALUES ('$description','$fileName')";
...
<form action="dis_complain.php" method="post" enctype="multipart/form-data">
